...
public class VerifyClientIdAccountIdTest {
	...
	public void testVerifyClientIdAccountIdPositive() throws SQLException {
		...
		.thenReturn(new Client(96,"Jane","Doe","12345678"));
		
		when(mockAccountDao.getAccountByAccountId(eq(96),eq(1)))
		.thenReturn(new Account(1, 96, "Checking", 90000.));
	...
	public void testVerifyClientIdAccountIdAccountNotFoundExceptionNegative() throws SQLException {
		...
		when(mockClientDao.getClientByClientId(eq(96)))
		.thenReturn(new Client(96,"First Name","Last","12345678"));
		
		when(mockAccountDao.getAccountByAccountId(eq(96),eq(96)))
		.thenReturn(null);
