...
public class UpdateClientTest {
	...
	public void testUpdateClientChangeFirstNameLastNamePositive() throws SQLException, InvalidParameterException {
		...
		when(mockClientDao.getClientByClientId(eq(96)))
		.thenReturn(new Client(96, "Jane", "Doe", "05162000"));
	...
	@Test
	public void testUpdateClientChangeLastNamePositive() 
	...
	@Test
	public void testUpdateClientFirstNameLastNameUncheckedNegative() 
			throws SQLException, InvalidParameterException {
	...
	@Test
	public void testUpdateClientChangedFirstNameButItsBlankNegative() 
			throws SQLException, InvalidParameterException {
	...
	@Test
	public void testUpdateClientChangedLastNameButItsBlankNegative() 
			throws SQLException, InvalidParameterException {
